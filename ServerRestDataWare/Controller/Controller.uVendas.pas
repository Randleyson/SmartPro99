...
unit Controller.uVendas;

interface

uses
  Module.DmVendas, Controller.oVendas;
...
function TControllerVendas.ReceberTicketMedio(oVendas: ToVendas;
  out sErro: string): Boolean;
begin
  Result := DmVendas.ReceberTicketMedio(oVendas,sErro);
end;
