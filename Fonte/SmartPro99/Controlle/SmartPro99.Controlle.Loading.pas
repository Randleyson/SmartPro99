unit SmartPro99.Controlle.Loading;
...
type
  TLoading = class
    ...
    public
          class procedure Show(const Frm : Tform; const msg : string);Overload;
          class procedure MostraMensagem(const msg : string);Overload;
...
class procedure TLoading.MostraMensagem(const msg: string);
begin
  if Assigned(Mensagem) then
  Mensagem.Text := msg;
end;
